...
| `adapters/evm-eas-anchor/README.md` | `62ace7c39b1c330d89942900ccd0bc1b5d645d511af4dd8dd8cb655840de5af6` |
...
The operator may ratify ADR-012 only against the complete fixed hash set. Until then the code
is an S8 candidate, the schema must not be registered as ACTA's binding v1 schema, and the S6
Artefact 1 remains not publicable.
